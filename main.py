...
class MizanAltamamAdvancedApp(App):
    def build(self):
        ...
        header = Label(
            ...
            markup=True, font_size=15, halign="center", valign="middle",
            color=(1.0, 0.84, 0.0, 1), size_hint_y=None, height=120
        )
        header.bind(size=header.setter('text_size'))
        main_layout.add_widget(header)

        phi = 1.618033988749895
        constants_text = (f"• الثابت الذهبي (Phi): {phi}\n"
                          f"• زاوية الإسقاط الهندسي: 137.508° (الزاوية المقدسة)\n"
                          f"• النظام: التمام الشامل - معايرة زمن البناء المطلق")
        const_lbl = Label(text=constants_text, font_size=13, halign="center", valign="middle", color=(0.9, 0.9, 0.9, 1), size_hint_y=None, height=90)
        ...
        self.input_dim = TextInput(text='1000', multiline=False, font_size=16, halign='center', size_hint_x=0.6)
        lbl_dim = Label(text="المقياس الأساسي:", font_size=13, color=(1, 1, 1, 1), size_hint_x=0.4, halign="right")
        ...
        self.result_lbl = Label(
            ...
            font_size=13, halign="center", valign="middle", color=(0.0, 1.0, 0.8, 1), size_hint_y=None, height=150
        )
        self.result_lbl.bind(size=self.result_lbl.setter('text_size'))
        main_layout.add_widget(self.result_lbl)

        calc_btn = Button(text="تشغيل مصفوفة ساعة التمام والإسقاط", size_hint_y=None, height=60, background_color=(0.1, 0.5, 0.8, 1))
    ...
    def calculate_projection(self, instance):
        ...
        output_str = (f"=== مصفوفة الإسقاط الهندسي الشامل ===\n"
